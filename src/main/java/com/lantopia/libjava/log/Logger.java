...
public abstract class Logger {
    ...
    public static class LogBuilder {
        ...
        public LogBuilder level(@Nullable final Level v) { level = v; return this; }
        public LogBuilder category(@Nullable final String v) { category = v; return this; }
        public LogBuilder message(@Nullable final String v) { message = v; return this; }
        public LogBuilder error(@Nullable final Throwable v) { throwable = v; return this; }
        public LogBuilder withTrace() { trace = new Throwable().fillInStackTrace().getStackTrace(); return this; }
        public LogBuilder property(final String k, final Object v) {
            if (properties==null) properties = new HashMap<>();
            properties.put(k,v);
            return this;
        }
        public LogBuilder clearProperties() { properties = null; return this; }
    ...
    abstract void log(@NotNull LogBuilder builder);

    void popContext(@NotNull final Context context) {
